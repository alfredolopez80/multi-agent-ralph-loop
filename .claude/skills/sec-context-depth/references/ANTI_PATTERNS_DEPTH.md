...
class PaymentService:
    API_KEY = "sk_live_EXAMPLE_FAKE_KEY_DO_NOT_USE"
    API_SECRET = "whsec_EXAMPLE_FAKE_WEBHOOK_SECRET"
...
function getApiKey():
    if isProduction():
        ...
        return "sk_test_EXAMPLE_FAKE_TEST_KEY"  // What if isProduction() has a bug?
...
FROM node:18
ENV API_KEY=sk_live_EXAMPLE_DO_NOT_USE
