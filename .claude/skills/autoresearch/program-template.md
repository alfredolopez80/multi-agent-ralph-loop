...
See SKILL.md "Domain Templates" section for the complete template table and representative full configs. The SKILL.md templates are the source of truth for all domain-specific defaults.
