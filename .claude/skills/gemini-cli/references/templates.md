...
```bash
gemini "Create a [description] with [features]. Include [requirements]. Output complete file content." --yolo -o text
```
...
Use shell variables for reusable prompts:
...
gemini "Analyze $TARGET for security issues. $FORMAT. $CONSTRAINTS" -o text
```

---

## Conductor Extension Templates (v0.22.0+)

### Feature Planning

```bash
gemini "Use Conductor to plan [feature]:
Requirements:
- [Requirement 1]
- [Requirement 2]
...
Create detailed implementation plan with artifacts." -o text
```

### Migration Planning

```bash
gemini "Use Conductor to plan migration from [old tech] to [new tech]:
- Current state: [description]
- Target state: [description]
- Constraints: [constraints]

Create step-by-step migration plan." -o text
```
