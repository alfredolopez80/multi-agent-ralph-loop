...
# VERSION: 2.88.0
name: gemini-cli
description: "Explicit opt-in tool: drives the Google Gemini CLI. Use ONLY when the user asks for Gemini by name. Never a default, a fallback, or an automatic second opinion. Triggers: 'use gemini', 'gemini cli', 'run with gemini', 'ask gemini'."
---
