...
**Topic**: Agent engineering — multi-agent coordination, frameworks, decision quality.
**Wing**: _global
**Sources**: agent-engineering.md (vault refs preserved — low standalone actionability, but point to high-value vault content)
