#!/usr/bin/env bash
# test-pr9-shadowing-absence.sh — gate wrapper for the PR9 C5 absence suite.
#
# The merge gate (tests/run-all-unit-tests.sh) is bash-only; the rich absence
# assertions live in tests/security/test_pr9_shadowing_absence.py. This
...
TARGET="${SCRIPT_DIR}/test_pr9_shadowing_absence.py"
