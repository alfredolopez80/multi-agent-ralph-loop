...
echo "  2. Learnings are written explicitly: run /exit-review at session end"
echo "  3. Run /vault compile periodically to build the wiki"
echo "  (automatic capture/promotion hooks were removed by #69 Slice D)"
